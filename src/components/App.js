...
// Import songs
import song1 from "../static/songs/Bachpan Ka Pyaar.mp3"
import song2 from "../static/songs/Desi Kalakaar.mp3"
import song3 from "../static/songs/Dhinka chika.mp3"
import song4 from "../static/songs/Kya Loge Tum.mp3"
import song5 from "../static/songs/Taro-Ke-Sahar-Me.mp3"

// Import song cover images
import song1Img from "../static/Bachpan-Ka-Pyaar-Badshah.jpg";
import song2Img from "../static/desi-kalakaar-honey-singh.jpg";
import song3Img from "../static/Dhinka chika Ready.jpg";
import song4Img from "../static/B praak.jpg";
import song5Img from "../static/taro ke sahar.jpg";
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {  
      ...
      songItems: ["Bachpan Ka Pyaar-Badshah", "Desi Kalakaar-Honey Singh", "Dhinka chika-Mika Singh","Kya Loge Tum- B-praak","Taro Ke Sahar Me-Neha Kakkar"], //song names
  ...
  // FUNCTION FOR : ON LONG PRESS OF FORWARD ARE BACKWARD
  seekSongReverse = (e) => {
    if (this.state.currentMenu === -2) {
      return;
    }
